...
type Queue struct {
	...
	// Subscribe to this channel to know whether queue is empty or not
...
// Adds an element (one) at the back of the queue
...
// Previous element at the front of queue
...
// Previous element at the back of queue
